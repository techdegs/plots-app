    ...
    <>
      <section className="bg-white border mx-10 mb-10">
        <div className="lg:grid lg:min-h-screen lg:grid-cols-12">
          ...
          <main className="flex gap-8 items-center justify-center px-8 py-8 sm:px-12 lg:col-span-7 lg:px-16 lg:py-12 xl:col-span-6">
              ...
              <div className="relative -mt-16 block lg:hidden mb-8">
                ...
                <di>
                  ...
                  <p className="mt-4 leading-relaxed text-gray-500">
                    ...
                    search filters and real-time updates, your next home is just
                    a tap away. Simplify your property search and embark on your
